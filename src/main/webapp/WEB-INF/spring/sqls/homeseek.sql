...
UPDATE MEMBER SET MEMBER_ENABLED = 'N' WHERE MEMBER_ID = 'rgusqls@naver.com';

UPDATE MEMBER SET MEMBER_ROLE = 'A' WHERE MEMBER_ID = 'admin@homeseek.com';

DELETE FROM MEMBER WHERE MEMBER_ID = 'yr9708@kakao.com';
...
SELECT * FROM NOTICE;
UPDATE NOTICE SET NOTICE_HIT = NOTICE_HIT + 1 WHERE NOTICE_NO = 2;
...
INSERT INTO DONATION VALUES(DONA_NO_SEQ.NEXTVAL, 1000, SYSDATE, 'yr9708@kakao.com');

SELECT * FROM DONATION WHERE DONA_ID = 'rgusqls@naver.com';
...
SELECT * FROM MESSAGE;
SELECT * FROM MESSAGE WHERE MESSAGE_SENID = 'rgusqls@naver.com'
ORDER BY MESSAGE_NO;
UPDATE MESSAGE SET MESSAGE_REDEL = 'D'
WHERE MESSAGE_NO = 32
AND MESSAGE_REDEL = 'R';

INSERT INTO MESSAGE VALUES(MESSAGE_NO_SEQ.NEXTVAL, 'rgusqls@naver.com', 'hwangingyu@gmail.com', 'ㅋㅋ', 'ㅋㅋ', SYSDATE, 'R', 'R');

UPDATE MESSAGE SET MESSAGE_REDEL = 'R'
WHERE MESSAGE_REID = 'rgusqls@naver.com';
...
DELETE FROM WISH WHERE WISH_ID = 'yr9708@kakao.com' AND WISH_SELL_ID = 'yr9708@kakao.com';
SELECT W.WISH_NO, R.ROOM_NAME, R.ROOM_ID, R.ROOM_REGDATE
		FROM WISH W JOIN ROOM R
		ON W.ROOM_NO = R.ROOM_NO
		WHERE W.WISH_ID = 'rgusqls@naver.com'
		ORDER BY W.WISH_NO ASC;

SELECT COUNT(*)
FROM WISH
WHERE WISH_ID = 'yr9708@kakao.com'
AND WISH_SELL_ID = 'rgusqls@naver.com';
